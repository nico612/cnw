...
class CourseRequestModel extends BaseRequestListMode {
  ...
  const CourseRequestModel({super.page, super.size, this.courseType, this.sortField = "time", this.isFree, this.category, this.code, this.difficulty});

  CourseRequestModel copyWith({int? page, int? size, int? courseType, String? sortField, bool? isFree, int? category, String? code, int? difficulty}) {
